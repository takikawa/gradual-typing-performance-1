...
(define-drbayes-arrow-comps store-uniform boolean ifte*)
...
(define-drbayes-arrow-comps neg exp log expm1 log1p sqrt asin acos)
(define-drbayes-arrow-comps floor ceiling round truncate)
(define-drbayes-arrow-comps normal-inv-cdf cauchy-inv-cdf uniform-inv-cdf)
